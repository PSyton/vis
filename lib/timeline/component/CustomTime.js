...
CustomTime.prototype.setOptions = function(options) {
  if (options) {
    ...
    util.selectiveExtend(['moment', 'locale', 'locales', 'id', 'cssClass', 'snap'], this.options, options);
  }
};
...
CustomTime.prototype._create = function() {
  ...
  if (this.options.id) {
    bar.className += ' ' + this.options.id;
  }
  if (this.options.cssClass) {
    bar.className += ' ' + this.options.cssClass;
  }
...
CustomTime.prototype._onDrag = function (event) {
  ...
  if (snap) {
    time = snap(time, this.body.util.getScale(), this.body.util.getStep());
  }
