...
},{"./lib/DataSet.js":2,"./lib/timeline/Timeline":14}],2:[function(require,module,exports){
...
},{"hammerjs":"hammerjs"}],7:[function(require,module,exports){
...
},{"../module/hammer":6,"../util":28,"emitter-component":29,"keycharm":30}],9:[function(require,module,exports){
var Emitter = require('emitter-component');
var Hammer = require('../module/hammer');
var util = require('../util');
var DataSet = require('../DataSet');
 ...
 */
Core.prototype.addCustomTime = function (time, cssClass, id) {
  if (time === undefined) {
  ...
  if (id === undefined) {
    ...
    customBarId = numIds.length > 0 ? Math.max.apply(null, numIds) + 1 : 0;
...
CustomTime.prototype.setOptions = function(options) {
  if (options) {
    // copy all options that we know
    util.selectiveExtend(['showCustomTime', 'locale', 'locales', 'id', 'cssClass', 'snap'], this.options, options);

    if (this.options.cssClass != null) {
      this.bar.className += " " + this.options.cssClass;
    }
...
CustomTime.prototype._onDrag = function (event) {
  ...
  this.setCustomTime(snap ? snap(time, scale, step) : time);
...
},{"../../module/hammer":6,"../../module/moment":7,"../../util":28,"../TimeStep":13,"../locales":27,"./Component":16}],19:[function(require,module,exports){
var util = require('../../util');
